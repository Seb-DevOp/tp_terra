...
<head>
    ...
    <!-- font css -->
    <link rel="stylesheet" href=" <?php echo e(asset('landing/assets/fonts/tabler-icons.min.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('landing/assets/fonts/feather.css')); ?>" />
    <link rel="stylesheet" href="  <?php echo e(asset('landing/assets/fonts/fontawesome.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('landing/assets/fonts/material.css')); ?>" />



    <!-- vendor css -->
    <link rel="stylesheet" href="  <?php echo e(asset('landing/assets/css/style.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('landing/assets/css/customizer.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('landing/assets/css/landing-page.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('landing/assets/css/custom.css')); ?>" />
...
<?php else: ?>
    ...
    <body class="<?php echo e($themeColor); ?>">
        ...
        <body class="theme-2">
                                ...
                                <?php if($key % 2 == 0): ?>
                                    <div class="row align-items-center justify-content-center mb-4">
                                        ...
                                        <div class="col-lg-7 col-md-6 res-img">
                                            <div class="<?php echo e(!empty($value['other_features_image']) ? 'img-wrapper' : ''); ?>">
            ...
            <script src="<?php echo e(asset('landing/assets/js/plugins/popper.min.js')); ?>"></script>
            <script src="<?php echo e(asset('landing/assets/js/plugins/bootstrap.min.js')); ?>"></script>
            <script src="<?php echo e(asset('landing/assets/js/plugins/feather.min.js')); ?>"></script>
