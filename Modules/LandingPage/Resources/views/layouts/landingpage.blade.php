...
<head>
    ...
    <!-- font css -->
    <link rel="stylesheet" href=" {{ asset('landing/assets/fonts/tabler-icons.min.css') }}" />
    <link rel="stylesheet" href=" {{ asset('landing/assets/fonts/feather.css') }}" />
    <link rel="stylesheet" href="  {{ asset('landing/assets/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ asset('landing/assets/fonts/material.css') }}" />



    <!-- vendor css -->
    <link rel="stylesheet" href="  {{ asset('landing/assets/css/style.css') }}" />
    <link rel="stylesheet" href=" {{ asset('landing/assets/css/customizer.css') }}" />
...
@else
    ...
    <body class="{{ $themeColor }}">
        ...
        <body class="theme-2">
            ...
            <script src="{{ asset('landing/assets/js/plugins/popper.min.js') }}"></script>
            <script src="{{ asset('landing/assets/js/plugins/bootstrap.min.js') }}"></script>
            <script src="{{ asset('landing/assets/js/plugins/feather.min.js') }}"></script>
